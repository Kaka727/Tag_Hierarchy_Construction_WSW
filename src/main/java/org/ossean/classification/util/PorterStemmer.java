...
public class PorterStemmer {
	...
	public String stem(String in){
		this.add(in.toCharArray(), in.length());
		this.stem();
	...
	public static void main(String[] argv) {
		// String
		// spath="e:\\lengzi\\software\\weka-3-5-0\\reut2-000stopwordsremoval.sgm";
		// String
		// dpath="e:\\lengzi\\software\\weka-3-5-0\\reut2-000stemmer.sgm";
		// Stemmer s = new Stemmer();
		// s.stem(spath,dpath);
//		String tmp = "consigned";
//		PorterStemmer s = new PorterStemmer();
//		s.add(tmp.toCharArray(), tmp.length());
//		s.stem();
//		System.out.println(s.toString());
//		
//		String tmp2 = "constable";
//		s.add(tmp2.toCharArray(), tmp2.length());
//		s.stem();
//		System.out.println(s.toString());
		String tmp = "cryptography";
		String tmp2 = "security";
		PorterStemmer s = new PorterStemmer();
		System.out.println(s.stem(tmp));
		System.out.println(s.stem(tmp2));
	}
